...
public class TestUtil {
    ...
    public static MockMultipartFile getMockMultiPartFile(String imageFilePath, String multipartFileName) {
        ...
        try {
            ...
            return new MockMultipartFile(multipartFileName, String.format("%s.%s", multipartFileName, extension), extension, inputStream);
        } catch (IOException e) {
